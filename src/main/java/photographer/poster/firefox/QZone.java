package photographer.poster.firefox;
...
public class QZone {
	...
	public static void postToQZone(
		...
		try {
			...
			driver = DriverHelper.firefox(conf);
			...
			System.out.println("loading album list - 1");
			
			driver.switchTo().defaultContent().switchTo().parentFrame(); // firefox
			
			// 点击“相册”按钮
			Thread.sleep(5000);
			//WebElement linkToAlbumList = driver.findElement(By.className("menu_item_4")).findElement(By.tagName("a"));
			WebElement linkToAlbumList = driver.findElement(By.xpath("//*[@id=\"menuContainer\"]/div/ul/li[3]/a"));
			linkToAlbumList.click();
			Thread.sleep(5000);
			
			System.out.println("loading album list - 2");
			...
			System.out.println("picture local path: " + file.getCanonicalPath());
